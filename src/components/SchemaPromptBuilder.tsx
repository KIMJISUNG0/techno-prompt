...
export default function SchemaPromptBuilder({ schema, bpm, meter, swing, extraSuffix }: Props){
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-white/10 bg-white/5 p-4">
        <h3 className="text-xs uppercase tracking-widest text-cyan-200 mb-2">Schema Builder (Universal + Genre)</h3>
      ...
      <div className="rounded-xl border border-white/10 bg-black/40 p-4">
        ...
        <div className="min-h-[120px] text-sm leading-relaxed bg-black/30 rounded-lg p-3 border border-slate-700">{prompt || <span className="text-slate-500">Build a prompt…</span>}</div>
